...
src/components/
  ...
  dashboard/    GreetingCard        — mascot + mood copy; chips de presupuesto cumplido debajo de fecha/layout con título "PRESUPUESTO PAGADO" (recibe budgets+categoryData)
                TotalCard           — ARS total, month net, currency breakdown; BudgetAlert si presupuesto restante supera patrimonio/ingresos
...
- Credit cards: `.fa-credit-cards .fa-credit-card`, pay: `getByTitle('Registrar pago')`, close: `getByTitle('Cerrar tarjeta')`, reopen: `getByTitle('Reactivar tarjeta')`, edit: `getByTitle('Editar')`, delete: `getByTitle('Eliminar')`
